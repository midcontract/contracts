...
contract EscrowHourly is IEscrowHourly, ERC1271 {
        ...
        onlyClient
    {
        ...
        if (
            W.weekStatus != Enums.Status.ACTIVE && W.weekStatus != Enums.Status.COMPLETED
        ...
        if (
            C.status == Enums.Status.COMPLETED || C.status == Enums.Status.CANCELED || C.status == Enums.Status.RESOLVED
